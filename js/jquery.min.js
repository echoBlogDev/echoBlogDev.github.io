...
i > 1 && sb(m),
i > 1 &&
qb(a.slice(0, i - 1).concat({ value: ' ' === a[i - 2].type ? '*' : '' })).replace(
R,
'$1'
),
c,
...
return (
!h || (d && !i) || ((c = c || []), (c = [a, c.slice ? c.slice() : c]), b ? i.push(c) : j(c)),
this
);
},
fire: function () {
...
i &&
!n.length &&
((l.teardown && l.teardown.call(a, p, r.handle) !== !1) || m.removeEvent(a, o, r.handle),
delete k[o]);
...
g = d ? d.length : 0;
for (
c.finish = !0, m.queue(this, a, []), e && e.stop && e.stop.call(this, !0), b = f.length;
b--;
