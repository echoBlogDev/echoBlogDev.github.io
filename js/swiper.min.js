...
for (
var E, S = t.slidesPerColumn, C = x / S, M = Math.floor(d / t.slidesPerColumn), k = 0;
k < d;
k += 1
) {
T = 0;
...
'prev' === t.swipeDirection &&
(z > 1 - i.longSwipesRatio ? t.slideTo(M + i.slidesPerGroup) : t.slideTo(M));
} else {
...
create: function () {
ee.extend(this, {
lazy: { initialImageLoaded: !1, load: F.load.bind(this), loadInSlide: F.loadInSlide.bind(this) }
});
},
on: {
beforeInit: function () {
